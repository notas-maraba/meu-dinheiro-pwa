const CACHE='meu-dinheiro-futuros-v10';
const FILES=['./','./index.html','./style.css','./cloud.css','./zoom.js','./cloud.js','./firebase-config.js','./app.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon.svg'];
