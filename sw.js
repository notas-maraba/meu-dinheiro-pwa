const CACHE='meu-dinheiro-responsive-v7';
const FILES=['./','./index.html','./style.css','./cloud.css','./cloud.js','./firebase-config.js','./app.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon.svg'];
