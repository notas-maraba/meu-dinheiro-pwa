const CACHE='meu-dinheiro-mobile-large-v15';
const FILES=['./','./index.html','./style.css?v=14','./cloud.css?v=14','./zoom.js','./cloud.js','./firebase-config.js','./app.js?v=10','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon.svg'];
